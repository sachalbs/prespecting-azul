...
const dict = {
  en: {
    ...
    connect: {
      tag: "Onboarding",
      step: "One decision, zero setup",
      hPre: "how do you want to talk to ",
      hAccent: "Azul?",
      sub: "Pick the channel you already live in. You can always switch later.",
      back: "Back",
      channels: {
        whatsapp: { name: "WhatsApp", desc: "Scan a code, say hi. Done." },
        slack: { name: "Slack", desc: "Azul joins your workspace." },
        teams: { name: "Teams", desc: "Azul joins your org." },
        telegram: { name: "Telegram", desc: "Scan a code, start the chat." },
      },
      waScan: "Scan with your phone",
      waOpen: "or open here",
  ...
  fr: {
    ...
    connect: {
      tag: "Onboarding",
      step: "Une décision, zéro réglage",
      hPre: "comment veux-tu parler à ",
      hAccent: "Azul ?",
      sub: "Choisis le canal où tu vis déjà. Tu pourras toujours changer plus tard.",
      back: "Retour",
      channels: {
        whatsapp: { name: "WhatsApp", desc: "Scanne un code, dis bonjour. C’est tout." },
        slack: { name: "Slack", desc: "Azul rejoint ton espace de travail." },
        teams: { name: "Teams", desc: "Azul rejoint ton organisation." },
        telegram: { name: "Telegram", desc: "Scanne un code, lance la discussion." },
      },
      waScan: "Scanne avec ton téléphone",
      waOpen: "ou ouvrir ici",
      slackBtn: "Add to Slack",
      teamsBtn: "Ajouter à Teams",
      pick: "choisis un canal",
      noteLabel: "Outlook ?",
