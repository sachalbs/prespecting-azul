      ...
      <div className="shell flex flex-col gap-8 py-12 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex flex-col gap-4 sm:items-end">
          <nav className="flex flex-wrap gap-x-6 gap-y-2">
            <a href="#how" className="text-[0.72rem] font-semibold uppercase tracking-label text-muted transition-colors hover:text-ink">
              Comment ça marche
            </a>
            <a href="#pilot" className="text-[0.72rem] font-semibold uppercase tracking-label text-muted transition-colors hover:text-ink">
              Le pilotage
            </a>
